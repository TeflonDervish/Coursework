...
class Ui_VisitorWindow(object):
    def setupUi(self, VisitorWindow):
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(0, 0, 1518, 421))
        ...
        self.gridLayout.addWidget(self.pack5, 3, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.pack6, 4, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.packTime, 6, 0, 1, 1)
    ...
    def retranslateUi(self, VisitorWindow):
        ...
        self.pack5.setText(_translate("VisitorWindow", "Пакет Гагарин (аниматор + пиньята + мыльные пузыри + час батутов + комната для чаепития)"))
        self.pack6.setText(_translate("VisitorWindow", "Эконом (час батутов + комната для чаепития)"))
        self.pack2.setText(_translate("VisitorWindow", "Пакет Невесомость (аниматор + час батутов + комната для чаепития)"))
        self.pack1.setText(_translate("VisitorWindow", "Час батутов!!!"))
        self.pack3.setText(_translate("VisitorWindow", "Пакет Спутник (аниматор + мыльные пузыри + час батутов + комната для чаепития)"))
