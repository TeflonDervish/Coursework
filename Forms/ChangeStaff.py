...
class Ui_ChangeStaff(object):
    def setupUi(self, ChangeStaff):
        ...
        self.middleName = QtWidgets.QLineEdit(self.formLayoutWidget)
        self.middleName.setObjectName("middleName")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.middleName)
    ...
    def retranslateUi(self, ChangeStaff):
        ...
        self.label_10.setText(_translate("ChangeStaff", "Отчество"))
